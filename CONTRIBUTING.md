...
```sh
git remote add bitpay git@github.com:bitpay/ioncore.git
...
```
Finally go to [github.com/bitpay/ioncore](https://github.com/bitpay/ioncore) in your web browser and issue a new pull request.
...
[github.com/bitpay/ioncore/issues](https://github.com/bitpay/ioncore/issues).
