...
var HDPrivateKey = ioncore.HDPrivateKey;
var HDPublicKey = ioncore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = ioncore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(ioncore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(ioncore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      ioncore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = ioncore.PublicKey.fromPoint;
      ioncore.PublicKey.fromPoint = function() {
        ioncore.PublicKey.fromPoint = unstubbed;
