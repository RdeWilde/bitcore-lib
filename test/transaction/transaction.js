...
var Input = ioncore.Transaction.Input;
var Output = ioncore.Transaction.Output;
var PrivateKey = ioncore.PrivateKey;
var Script = ioncore.Script;
var Address = ioncore.Address;
var Networks = ioncore.Networks;
var Opcode = ioncore.Opcode;
...
describe('Transaction', function() {
  ...
  it('fromObject with pay-to-public-key previous outputs', function() {
    ...
    tx.inputs[0].should.be.instanceof(ioncore.Transaction.Input.PublicKey);
  ...
  describe('checks on adding inputs', function() {
    ...
    it('will add an empty script if not supplied', function() {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(ioncore.Script);
